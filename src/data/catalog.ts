...
const raw: Array<[string, string, number, string?, string?]> = [
  // fastfood
  ["fastfood", "ستريبس دولفين", 200, "عبوة", imgStripsDolphin],
  ["fastfood", "ستريبس ولعتين", 280, "عبوة", imgStripsWal3ten],
  ["fastfood", "ستريبس ميزه / الحريف / أطياب", 215, "عبوة", imgStripsMeza],
  ["fastfood", "صدور فراشه سمارت", 270, "عبوة", imgChickenBreast],
  ...
  ["burgers", "برجر ميتكو الاسود الجامبو", 220, "كيلو", imgBurgerMitko],
  ...
  ["burgers", "كبده عصافيرى متبله سجود", 95, "عبوة", imgLiverSogod],
  ...
  ["dairy", "موزاريلا", 100, "نص كيلو", imgMozzarella],
  ["dairy", "مكس", 95, "نص كيلو", imgMix],
  ["dairy", "صوص شيدر طبيعي", 100, "نص كيلو", imgCheddarSauce],
